...
const cacheName = 'TGfinalProject-2021-05-02 16:33:38.501404'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'images1/imgPothos.jpeg',
  'images1/imgSpiderPlant.jpeg',
  'images1/imgAloeVera.jpeg',
  'images1/imgTullip.jpeg',
  'images1/imgRose.jpeg',
  'images1/imgHydrangea.jpeg',
  'images1/imgSnakePlant.jpeg',
  'images1/imgGeranium.jpeg',
  'images1/imgOrchid.jpeg',
  'images1/imgJadePlant.jpeg',
  'images1/imgSucculent.jpeg',
  'images1/imgCactus.jpeg',
  'images1/imgDaffodils.jpeg',
  'images1/imgPilea.jpeg',
  'images1/imgMoneyPlant.jpeg',
  'images1/imgLillies.jpeg',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'TGfinalProject'.length) === 'TGfinalProject') {
